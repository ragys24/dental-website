  ...
  return (
    <>
      <PageSEO
        ...
        description="3D-guided dental implants in Garden Grove, CA. Permanent tooth replacement with SprintRay technology. Free implant consultation."
      ...
      <ServiceSchema
        ...
        description="Dental implant placement and restoration in Garden Grove, CA. Single tooth implants, implant-supported bridges, and All-on-4 solutions."
        url="https://upliftdental.com/dental-implants"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact" onClick={trackSchedule} className="btn-uplift-white rounded-full px-7 py-3">
                  Free Implant Consultation
                </Link>
                <a href={PRACTICE.phone.tel} onClick={trackSchedule} className="flex items-center justify-center gap-2 px-7 py-3 rounded-full border-2 border-white/50 text-white font-body font-semibold hover:bg-white/10 transition-all">
      ...
      {/* Alternative: Dentures */}
      <section className="py-20" style={{ backgroundColor: "oklch(0.97 0.008 192)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              <h2 className="font-display text-4xl text-[oklch(0.18_0.04_185)] mb-6">Alternative: 3D-Printed Dentures</h2>
              <p className="font-body text-[oklch(0.40_0.04_185)] leading-relaxed mb-6">
                While dental implants are ideal for many patients, 3D-printed dentures offer an affordable alternative for complete tooth replacement. Using advanced digital technology, we create custom dentures that fit perfectly and feel natural.
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  "Affordable tooth replacement option",
                  "Custom-fit using 3D digital scanning",
                  "Ready in 1-2 weeks",
            ...
            <div className="grid grid-cols-2 gap-4">
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663519418507/8XjTa97CZebFmBgqStQiLN/3ddenture2_0802583c.webp" alt="3D-printed denture fabrication showing digital design and precision engineering for tooth replacement" className="w-full rounded-2xl object-cover shadow-lg h-48" loading="lazy" width="400" height="300"/>
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663519418507/8XjTa97CZebFmBgqStQiLN/Denture3d_b263eb16.webp" alt="Completed 3D-printed denture restoration showing natural tooth color and realistic gum appearance" className="w-full rounded-2xl object-cover shadow-lg h-48" loading="lazy" width="400" height="300"/>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 text-center" style={{ backgroundColor: "oklch(0.42 0.09 185)" }}>
        <div className="max-w-2xl mx-auto px-4">
          ...
          <Link href="/contact" onClick={trackSchedule} className="btn-uplift-white rounded-full px-8 py-4 text-base font-bold inline-flex items-center gap-2">
            Book Free Consultation <ChevronRight className="w-5 h-5" />
          </Link>
        </div>
      </section>

      <RelatedServices exclude={["/dental-implants"]} limit={4} />
      <Footer />
    </div>
    </>
  );
